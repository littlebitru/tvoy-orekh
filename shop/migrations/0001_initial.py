# Generated by Django 5.2.6 on 2026-07-11 13:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('new', 'Новый'), ('paid', 'Оплачен'), ('sent', 'Передан в доставку'), ('done', 'Выполнен')], default='new', max_length=10, verbose_name='статус')),
